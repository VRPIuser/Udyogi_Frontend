...
const ExperienceSectionHead = ({
  ...
  return (
    <div className="flex gap-4 justify-between items-center mb-4 ">
      ...
      >
        <h3>Experience{" " + Number(index + 1)}</h3>
        <CustomImage
          ...
          height={10}
          style={{
            transform: experience.expanded ? "rotate(180deg)" : "",
      ...
      {index !== 0 && (
        <CustomImage
          ...
          onClick={() => handleRemoveExperience(experience.id)} // Corrected line
        />
      )}
    </div>
  );
...
export default ExperienceSectionHead;
